...
from apps.apifilter.serializers import CustomUserFilterSerializer


class CustomUserFilterAV(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if from_date and to_date:  # check if key is not None
            date_format = '%d-%m-%Y'
            from_date = datetime.strftime(from_date, date_format)  # convert string into date format
